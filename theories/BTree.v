...
(* 
   A leaf tree has disting leaves 
   *)
...
Qed.
(* 
   If list of all the leaves of the tree is unique then the tree has
   distinct leaves
   *)
...
Qed.
(* 
   If the tree has distinct leaves then the list of all the leaves 
