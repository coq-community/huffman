...
intros t H1; split; try exact (pb_unique_prefix1 t); apply pb_unique_key;
 auto.
Qed.
(* 
...
Qed.
(* 
   Adding in a leaf, just create a singleton list
   *)
...
(* 
   ...
   create a tree with distinct leaves 
   *)
...
Qed.
(* 
   Leaves in a built tree are element of the codes
   *)
